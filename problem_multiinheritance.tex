...
\input{problem_multiinheritance_1}
...
\input{problem_multiinheritance_3}

\subsubsection{Задача 4}

Измените код программы по задаче 3 так, чтобы в дочернем классе вызов 
...
дочернем классе вызов инициализаторов всех трёх наследуемых классов 
